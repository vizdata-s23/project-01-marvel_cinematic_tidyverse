...
p <- ggplot(comprehensive_heat, aes(x=maxplayers, y = minplayers, fill = average)) +
  ...
  labs(title = "Average Rating Based on Min and Max Players", x = "Minimum Number of Players", y = "Maximum Number of Players", fill = "Average Rating") + theme_grey() + guides(fill = guide_colourbar(barwidth = 0.5,
                                barheight = 8))
